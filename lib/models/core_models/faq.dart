...
class FAQ {
  ...
  @override
  String toString() => 'FAQ(questionText: $questionText, answerText: $answerText, order: $order)';
  ...
  @override
  int get hashCode => questionText.hashCode ^ answerText.hashCode ^ order.hashCode;
}
